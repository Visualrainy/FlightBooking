...
class ConsumptionViewModel @Inject constructor(private val profileService: ProfileService) : ViewModel() {
    private val _consumptions = MutableLiveData<Pair<ConsumptionsStatus, List<Consumption>?>>()
    val consumptions: LiveData<Pair<ConsumptionsStatus, List<Consumption>?>> = _consumptions
